            ...
            {loading ? (
                ...
                <>
                    <div className="flex flex-wrap gap-4 mb-10">
                        <TabButton id="watchlist" label="Watchlist" count={data.to_watch.length} />
                        <TabButton id="watched" label="Watched" count={data.watched.length} />
                        <TabButton id="rated" label="Rated" count={data.rated_movies.length} />
                    </div>
