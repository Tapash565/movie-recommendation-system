        ...
        <div className="relative z-10 p-10 md:p-24 flex flex-col items-center text-center">
          ...
          >
            ...
            <input
              ...
              className="relative w-full bg-[#1e293b] border border-white/10 rounded-2xl px-8 py-5 text-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all shadow-xl"
              value={searchQuery}
